              ...
              <div className="row g-4">
                  <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                      <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                          ...
                          >
                              <img className="img-fluid" src={images.img_haircut} alt="" />
                          </div>
                          <div className="ps-4">
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                      <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                          <div
                              ...
                              style={{ width: 60, height: 60 }}
                          >
                              <img className="img-fluid" src={images.img_beard_trim} alt="" />
                          </div>
                          <div className="ps-4">
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                      <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                          <div
                              ...
                              style={{ width: 60, height: 60 }}
                          >
                              <img className="img-fluid" src={images.img_mans_shave} alt="" />
                          </div>
                          <div className="ps-4">
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                      <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                          <div
                              ...
                              style={{ width: 60, height: 60 }}
                          >
                              <img className="img-fluid" src={images.img_hair_dyeing} alt="" />
                          </div>
                          <div className="ps-4">
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                      <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                          <div
                              ...
                              style={{ width: 60, height: 60 }}
                          >
                              <img className="img-fluid" src={images.img_mustache} alt="" />
                          </div>
                          <div className="ps-4">
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                      <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                          <div
                              ...
                              style={{ width: 60, height: 60 }}
                          >
                              <img className="img-fluid" src={images.img_stacking} alt="" />
                          </div>
                          <div className="ps-4">
